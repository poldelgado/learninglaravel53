        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('productos.update', $producto->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('description')) has-error @endif">
                    ...
                    <input type="text" id="description-field" name="description" class="form-control" value="{{ is_null(old("description")) ? $producto->description : old("description") }}"/>
                    ...
                    <input type="text" id="stock-field" name="stock" class="form-control" value="{{ is_null(old("stock")) ? $producto->stock : old("stock") }}"/>
                       @if($errors->has("stock"))
